...
const BuildDigital = () => {
  ...
  return (
    <>
      <div className='mt-12'>
        <VelocityScroll
          text="We Build You Digitally   "
          default_velocity={5}
          className="font-display text-center text-4xl font-bold tracking-[-0.02em] text-[#605e5e] drop-shadow-sm md:text-7xl md:leading-[5rem] whitespace-pre"
        />
      </div>
