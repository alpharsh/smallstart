    ...
    <>
      ...
      <div className="logos overflow-hidden relative">
        <div className="logos-slide flex items-center">
          <img src="/clientimg/client1.png" alt="Client 1" className="h-16 mx-4 grayscale" />
          <img src="/clientimg/client2.png" alt="Client 2" className="h-16 mx-4 grayscale" />
          <img src="/clientimg/client3.png" alt="Client 3" className="h-16 mx-4 grayscale" />
          <img src="/clientimg/client4.png" alt="Client 4" className="h-16 mx-4 grayscale" />
          <img src="/clientimg/client5.png" alt="Client 5" className="h-16 mx-4 grayscale" />
          <img src="/clientimg/client6.png" alt="Client 6" className="h-16 mx-4 grayscale" />
